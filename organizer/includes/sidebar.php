...
<aside class="sidebar" id="sidebar">
  ...
  <div class="sidebar-brand">
    ...
    <div class="sidebar-brand-info">
      ...
      <div class="sidebar-brand-sub">Organizer Portal</div>
    </div>
  </div>
  ...
  <nav class="sidebar-nav">
    <div class="sidebar-section">
      ...
      <a href="create-event.php" class="sidebar-link <?= $activePage==='create-event'?'active':'' ?>">
        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><circle cx="12" cy="12" r="10"/><line x1="12" y1="8" x2="12" y2="16"/><line x1="8" y1="12" x2="16" y2="12"/></svg>
        Create Event
      </a>

      <a href="my-events.php" class="sidebar-link <?= $activePage==='my-events'?'active':'' ?>">
  ...
  <div class="sidebar-footer">
    <div class="sidebar-user">
      ...
      <div class="sidebar-user-info">
        ...
        <div class="sidebar-user-role">Organizer</div>
      </div>
    </div>
